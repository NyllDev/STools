...
module.exports = (_ => {
    const config = {
        ...
        "changeLog": {
            "improved": {
                "Общее": "Исправлена ошибка при загрузки плагина."
            }
        }
    };

    const muteStorage = [
        {time: 40,	 label: "Мат", 												reason: "Мат в любом из каналов чата", 													rule: "Запрещен мат в любом канале/чате. | Mute: 40-100m",                                                      color: "colorBrand"},
        {time: 30,	 label: "Флуд", 											reason: "Флуд (от 3 одинаковых сообщений подряд менее чем за минуту)", 					rule: "Запрещено флудить(от 3-ех одинаковых сообщений в минуту(касается и смайликов)) | Mute:  30 - 60m ",      color: "colorBrand"},
        {time: 30,	 label: "Капс",  											reason: "Капс в чате", 																	rule: "Запрещено использовать CAPS(исключение: выделение определенного слова в предложении). | Mute 30-100m",   color: "colorBrand"},
        {time: 60,	 label: "Оскорбление", 										reason: "Оскорбление участников", 														rule: "Запрещено в любом виде оскорблять любых участников в любом из каналов. | Mute: 60-180m",                 color: "colorBrand"},
        {time: 40,	 label: "Завуалированный мат", 								reason: "Завуалированный мат", 															rule: "Запрещено завуалировать мат(как дополнение к пункту 8). | Mute: 40-100m",                                color: "colorBrand"},
